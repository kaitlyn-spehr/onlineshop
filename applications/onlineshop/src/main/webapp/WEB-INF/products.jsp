...
<div class="container">
    ...
    <h1>products</h1>
    <form class="product-input-form form-inline" action="/products/add" method="post">
        <p>Add Product</p>
    ...
    <table class="table table-striped table-bordered">
        ...
        <c:forEach items="${requestScope.products}" var="product">
            <tr>
                ...
                <td><fmt:formatNumber value = "${product.pdcost}" type = "currency"/></td>
                <td> ${product.pddescp} </td>
                <td> ${product.pdquantity} </td>
                <td><a href="/products/delete/${product.id}"><i class="icon-trash"></i></a></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
